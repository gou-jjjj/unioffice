...
type storage interface {
	Open(_d string) (File, error)
	TempFile(_c, _g string) (File, error)
	TempDir(_cc string) (string, error)
	RemoveAll(_df string) error
	Add(_b string) error
}
...
func SetAsStorage(newStorage storage) { _be = newStorage }
...
func Open(path string) (File, error) { return _be.Open(path) }
