...
func (_agbc nsSet) applyToNode(_fc *any) {
	if _fc.XMLName.Space == "" {
		return
	}
	_adb := _agbc.getPrefix(_fc.XMLName.Space)
	_fc.XMLName.Space = ""
	_fc.XMLName.Local = _adb + "\u003a" + _fc.XMLName.Local
	_ee := _fc.Attrs
	_fc.Attrs = nil
	for _, _gdb := range _ee {
		if _gdb.Name.Space == "\u0078\u006d\u006cn\u0073" {
			continue
		}
		if _gdb.Name.Space != "" {
			_caa := _agbc.getPrefix(_gdb.Name.Space)
			_gdb.Name.Space = ""
			_gdb.Name.Local = _caa + "\u003a" + _gdb.Name.Local
		}
		_fc.Attrs = append(_fc.Attrs, _gdb)
	}
	for _, _gfa := range _fc.Nodes {
		_agbc.applyToNode(_gfa)
	}
}
...
func AbsoluteFilename(dt DocType, typ string, index int) string {
	...
	case CustomXMLType:
		return _e.Sprintf("c\u0075s\u0074\u006f\u006d\u0058\u006d\u006c\u002f\u0069t\u0065\u006d\u0025\u0064.x\u006d\u006c", index)
	...
	case OfficeDocumentType, OfficeDocumentTypeStrict:
		...
		default:
			_cd.Log.Debug("\u0075\u006e\u0073u\u0070\u0070\u006f\u0072t\u0065\u0064\u0020\u0074\u0079\u0070\u0065 \u0025\u0073\u0020\u0070\u0061\u0069\u0072\u0020\u0061\u006e\u0064\u0020\u0025\u0076", typ, dt)
		}
	case ThemeType, ThemeTypeStrict, ThemeContentType:
		switch dt {
		case DocTypeSpreadsheet:
			return _e.Sprintf("x\u006c/\u0074\u0068\u0065\u006d\u0065\u002f\u0074\u0068e\u006d\u0065\u0025\u0064.x\u006d\u006c", index)
		case DocTypeDocument:
			return _e.Sprintf("\u0077\u006f\u0072\u0064/t\u0068\u0065\u006d\u0065\u002f\u0074\u0068\u0065\u006d\u0065\u0025\u0064\u002e\u0078m\u006c", index)
		case DocTypePresentation:
			return _e.Sprintf("p\u0070\u0074\u002f\u0074he\u006de\u002f\u0074\u0068\u0065\u006de\u0025\u0064\u002e\u0078\u006d\u006c", index)
		default:
			_cd.Log.Debug("\u0075\u006e\u0073u\u0070\u0070\u006f\u0072t\u0065\u0064\u0020\u0074\u0079\u0070\u0065 \u0025\u0073\u0020\u0070\u0061\u0069\u0072\u0020\u0061\u006e\u0064\u0020\u0025\u0076", typ, dt)
		}
	...
	case ChartType, ChartTypeStrict, ChartContentType:
		switch dt {
		case DocTypeSpreadsheet:
			return _e.Sprintf("x\u006c\u002f\u0063\u0068ar\u0074s\u002f\u0063\u0068\u0061\u0072t\u0025\u0064\u002e\u0078\u006d\u006c", index)
		case DocTypeDocument:
			return _e.Sprintf("\u0077\u006f\u0072d/\u0063\u0068\u0061\u0072\u0074\u0073\u002f\u0063\u0068\u0061\u0072\u0074\u0025\u0064\u002e\u0078\u006d\u006c", index)
		case DocTypePresentation:
			return _e.Sprintf("\u0070\u0070\u0074\u002fch\u0061\u0072\u0074\u0073\u002f\u0063\u0068\u0061\u0072\u0074\u0025\u0064\u002e\u0078m\u006c", index)
		default:
			_cd.Log.Debug("\u0075\u006e\u0073u\u0070\u0070\u006f\u0072t\u0065\u0064\u0020\u0074\u0079\u0070\u0065 \u0025\u0073\u0020\u0070\u0061\u0069\u0072\u0020\u0061\u006e\u0064\u0020\u0025\u0076", typ, dt)
		}
	case TableType, TableTypeStrict, TableContentType:
		return _e.Sprintf("x\u006c\u002f\u0074\u0061bl\u0065s\u002f\u0074\u0061\u0062\u006ce\u0025\u0064\u002e\u0078\u006d\u006c", index)
	case DrawingType, DrawingTypeStrict, DrawingContentType:
		switch dt {
		case DocTypeSpreadsheet:
			return _e.Sprintf("\u0078l\u002f\u0064\u0072\u0061w\u0069\u006e\u0067\u0073\u002fd\u0072a\u0077i\u006e\u0067\u0025\u0064\u002e\u0078\u006dl", index)
		default:
			_cd.Log.Debug("\u0075\u006e\u0073u\u0070\u0070\u006f\u0072t\u0065\u0064\u0020\u0074\u0079\u0070\u0065 \u0025\u0073\u0020\u0070\u0061\u0069\u0072\u0020\u0061\u006e\u0064\u0020\u0025\u0076", typ, dt)
		}
	case CommentsType, CommentsTypeStrict, CommentsContentType:
		switch dt {
		case DocTypeSpreadsheet:
			return _e.Sprintf("\u0078\u006c\u002f\u0063\u006f\u006d\u006d\u0065\u006e\u0074\u0073\u0025d\u002e\u0078\u006d\u006c", index)
		case DocTypeDocument:
	...
	case VMLDrawingType, VMLDrawingTypeStrict, VMLDrawingContentType:
		switch dt {
		case DocTypeSpreadsheet:
			return _e.Sprintf("\u0078\u006c\u002f\u0064r\u0061\u0077\u0069\u006e\u0067\u0073\u002f\u0076\u006d\u006cD\u0072a\u0077\u0069\u006e\u0067\u0025\u0064\u002ev\u006d\u006c", index)
		default:
			_cd.Log.Debug("\u0075\u006e\u0073u\u0070\u0070\u006f\u0072t\u0065\u0064\u0020\u0074\u0079\u0070\u0065 \u0025\u0073\u0020\u0070\u0061\u0069\u0072\u0020\u0061\u006e\u0064\u0020\u0025\u0076", typ, dt)
		}
	case ImageType, ImageTypeStrict:
		switch dt {
		case DocTypeDocument:
			return _e.Sprintf("\u0077\u006f\u0072\u0064/m\u0065\u0064\u0069\u0061\u002f\u0069\u006d\u0061\u0067\u0065\u0025\u0064\u002e\u0070n\u0067", index)
		case DocTypeSpreadsheet:
			return _e.Sprintf("x\u006c/\u006d\u0065\u0064\u0069\u0061\u002f\u0069\u006da\u0067\u0065\u0025\u0064.p\u006e\u0067", index)
		case DocTypePresentation:
			return _e.Sprintf("p\u0070\u0074\u002f\u006ded\u0069a\u002f\u0069\u006d\u0061\u0067e\u0025\u0064\u002e\u0070\u006e\u0067", index)
		default:
			_cd.Log.Debug("\u0075\u006e\u0073u\u0070\u0070\u006f\u0072t\u0065\u0064\u0020\u0074\u0079\u0070\u0065 \u0025\u0073\u0020\u0070\u0061\u0069\u0072\u0020\u0061\u006e\u0064\u0020\u0025\u0076", typ, dt)
		}
	case WorksheetType, WorksheetTypeStrict, WorksheetContentType:
		return _e.Sprintf("\u0078l\u002f\u0077\u006f\u0072k\u0073\u0068\u0065\u0065\u0074s\u002fs\u0068e\u0065\u0074\u0025\u0064\u002e\u0078\u006dl", index)
	...
	case HeaderType, HeaderTypeStrict:
		return _e.Sprintf("\u0077\u006f\u0072\u0064\u002f\u0068\u0065\u0061\u0064\u0065\u0072\u0025d\u002e\u0078\u006d\u006c", index)
	case FooterType, FooterTypeStrict:
		return _e.Sprintf("\u0077\u006f\u0072\u0064\u002f\u0066\u006f\u006f\u0074\u0065\u0072\u0025d\u002e\u0078\u006d\u006c", index)
	case ControlType, ControlTypeStrict:
		switch dt {
		case DocTypeSpreadsheet:
			return _e.Sprintf("\u0078l\u002f\u0061\u0063\u0074\u0069\u0076\u0065\u0058\u002f\u0061\u0063t\u0069\u0076\u0065\u0058\u0025\u0064\u002e\u0078\u006d\u006c", index)
		case DocTypeDocument:
			return _e.Sprintf("\u0077\u006f\u0072\u0064\u002f\u0061\u0063\u0074\u0069\u0076\u0065X\u002f\u0061\u0063\u0074\u0069\u0076\u0065\u0058\u0025\u0064.\u0078\u006d\u006c", index)
		case DocTypePresentation:
			return _e.Sprintf("\u0070p\u0074\u002f\u0061\u0063t\u0069\u0076\u0065\u0058\u002fa\u0063t\u0069v\u0065\u0058\u0025\u0064\u002e\u0078\u006dl", index)
		default:
			_cd.Log.Debug("\u0075\u006e\u0073u\u0070\u0070\u006f\u0072t\u0065\u0064\u0020\u0074\u0079\u0070\u0065 \u0025\u0073\u0020\u0070\u0061\u0069\u0072\u0020\u0061\u006e\u0064\u0020\u0025\u0076", typ, dt)
		}
	case SlideType, SlideTypeStrict:
		return _e.Sprintf("\u0070\u0070\u0074\u002fsl\u0069\u0064\u0065\u0073\u002f\u0073\u006c\u0069\u0064\u0065\u0025\u0064\u002e\u0078m\u006c", index)
	case SlideLayoutType:
		return _e.Sprintf("\u0070\u0070\u0074/s\u006c\u0069\u0064\u0065\u004c\u0061\u0079\u006f\u0075t\u0073/\u0073l\u0069d\u0065\u004c\u0061\u0079\u006f\u0075\u0074\u0025\u0064\u002e\u0078\u006d\u006c", index)
	case SlideMasterType:
		return _e.Sprintf("\u0070\u0070\u0074/s\u006c\u0069\u0064\u0065\u004d\u0061\u0073\u0074\u0065r\u0073/\u0073l\u0069d\u0065\u004d\u0061\u0073\u0074\u0065\u0072\u0025\u0064\u002e\u0078\u006d\u006c", index)
	case HandoutMasterType:
		return _e.Sprintf("\u0070\u0070\u0074\u002f\u0068\u0061\u006e\u0064\u006f\u0075\u0074\u004d\u0061\u0073\u0074\u0065\u0072\u0073\u002f\u0068\u0061\u006e\u0064\u006fu\u0074\u004d\u0061\u0073\u0074e\u0072\u0025d\u002e\u0078\u006d\u006c", index)
	case NotesMasterType:
		return _e.Sprintf("\u0070\u0070\u0074/n\u006f\u0074\u0065\u0073\u004d\u0061\u0073\u0074\u0065r\u0073/\u006eo\u0074e\u0073\u004d\u0061\u0073\u0074\u0065\u0072\u0025\u0064\u002e\u0078\u006d\u006c", index)
	default:
		_cd.Log.Debug("\u0075\u006e\u0073\u0075pp\u006f\u0072\u0074\u0065\u0064\u0020\u0074\u0079\u0070\u0065\u0020\u0025\u0073", typ)
	}
	return ""
}
...
func _gdg(_bea []*any) []*XSDAny {
	_dde := []*XSDAny{}
	for _, _ddg := range _bea {
		_edb := &XSDAny{}
		_edb.XMLName = _ddg.XMLName
		_edb.Attrs = _ddg.Attrs
		_edb.Data = _ddg.Data
		_edb.Nodes = _gdg(_ddg.Nodes)
		_dde = append(_dde, _edb)
	}
	return _dde
}

const MinGoVersion = _cc

// Uint8 returns a copy of v as a pointer.
func Uint8(v uint8) *uint8 { _ac := v; return &_ac }
...
func CreateElement(start _f.StartElement) (Any, error) {
	_bf, _ea := _db[start.Name.Space+"\u002f"+start.Name.Local]
	if !_ea {
		_de := &XSDAny{}
		return _de, nil
	}
	...
	_cdd := _ga.Call(nil)
	if len(_cdd) != 1 {
		return nil, _e.Errorf("\u0063\u006fn\u0073\u0074\u0072\u0075\u0063t\u006f\u0072\u0020\u0066\u0075n\u0063\u0074\u0069\u006f\u006e\u0020\u0073\u0068\u006f\u0075\u006c\u0064\u0020\u0072\u0065\u0074\u0075\u0072\u006e\u0020\u006f\u006e\u0065\u0020\u0076\u0061\u006c\u0075\u0065\u002c\u0020\u0067\u006f\u0074\u0020\u0025\u0064", len(_cdd))
	}
	_bce, _ea := _cdd[0].Interface().(Any)
	if !_ea {
		return nil, _c.New("\u0063o\u006e\u0073t\u0072\u0075\u0063\u0074o\u0072\u0020\u0066u\u006e\u0063\u0074\u0069\u006f\u006e\u0020\u0073\u0068ou\u006c\u0064\u0020r\u0065\u0074u\u0072\u006e\u0020\u0061\u006e\u0079 \u0027\u0041n\u0079\u0027")
	}
	return _bce, nil
}
...
func RelativeImageFilename(dt DocType, relToTyp, typ string, index int, fileExtension string) string {
	_a := RelativeFilename(dt, relToTyp, typ, index)
	return _a[0:len(_a)-3] + fileExtension
}
func (_ba *XSDAny) collectNS(_fb *nsSet) {
	if _ba.XMLName.Space != "" {
		_fb.getPrefix(_ba.XMLName.Space)
	}
	for _, _cca := range _ba.Attrs {
		if _cca.Name.Space != "" && _cca.Name.Space != "\u0078\u006d\u006cn\u0073" {
			_fb.getPrefix(_cca.Name.Space)
		}
	}
	for _, _bef := range _ba.Nodes {
		_bef.collectNS(_fb)
	}
}

// UnmarshalXML implements the xml.Unmarshaler interface.
func (_dag *XSDAny) UnmarshalXML(d *_f.Decoder, start _f.StartElement) error {
	_gf := any{}
	if _cg := d.DecodeElement(&_gf, &start); _cg != nil {
		return _cg
	}
	_ddc(&_gf)
	_dag.XMLName = _gf.XMLName
	_dag.Attrs = _gf.Attrs
	_dag.Data = _gf.Data
	_dag.Nodes = _gdg(_gf.Nodes)
	return nil
}

// MarshalXML implements the xml.Marshaler interface.
func (_bcb *XSDAny) MarshalXML(e *_f.Encoder, start _f.StartElement) error {
	start.Name = _bcb.XMLName
	start.Attr = _bcb.Attrs
	_dea := any{}
	_dea.XMLName = _bcb.XMLName
	_dea.Attrs = _bcb.Attrs
	_dea.Data = _bcb.Data
	_dea.Nodes = _cbg(_bcb.Nodes)
	_dgf := []string{}
	_fa := false
	_agb := nsSet{_ab: map[string]string{}, _ae: map[string]string{}}
	_bcb.collectNS(&_agb)
	_agb.applyToNode(&_dea)
	for _, _aa := range _agb._bee {
		if _, _faf := _gfd[_aa]; _faf {
			_dgf = append(_dgf, _aa)
		}
		_ged := _agb._ae[_aa]
		_dea.Attrs = append(_dea.Attrs, _f.Attr{Name: _f.Name{Local: "\u0078\u006d\u006c\u006e\u0073\u003a" + _aa}, Value: _ged})
		if _aa == "\u006d\u0063" {
			_fa = true
		}
	}
	for _, _bba := range _dea.Attrs {
		if _bba.Name.Local == "\u006d\u0063\u003aI\u0067\u006e\u006f\u0072\u0061\u0062\u006c\u0065" {
			_fa = false
			break
		}
	}
	if _fa && len(_dgf) > 0 {
		_dea.Attrs = append(_dea.Attrs, _f.Attr{Name: _f.Name{Local: "\u006d\u0063\u003aI\u0067\u006e\u006f\u0072\u0061\u0062\u006c\u0065"}, Value: _g.Join(_dgf, "\u0020")})
	}
	return e.Encode(&_dea)
}
func _cbg(_cde []*XSDAny) []*any {
	_ggc := []*any{}
	for _, _daae := range _cde {
		_gec := &any{}
		_gec.XMLName = _daae.XMLName
		_fff := []_f.Attr{}
		for _, _gfg := range _daae.Attrs {
			if _gfg.Name.Local != "\u0078\u006d\u006cn\u0073" {
				_fff = append(_fff, _gfg)
			}
		}
		_gec.Attrs = _fff
		_gec.Data = _daae.Data
		_gec.Nodes = _cbg(_daae.Nodes)
		_ggc = append(_ggc, _gec)
	}
	return _ggc
}
...
func Float64(v float64) *float64 { _egc := v; return &_egc }

// String returns a copy of v as a pointer.
func String(v string) *string { _efb := v; return &_efb }

// AddPreserveSpaceAttr adds an xml:space="preserve" attribute to a start
// element if it is required for the string s.
func AddPreserveSpaceAttr(se *_f.StartElement, s string) {
	if NeedsSpacePreserve(s) {
		se.Attr = append(se.Attr, _f.Attr{Name: _f.Name{Local: "\u0078m\u006c\u003a\u0073\u0070\u0061\u0063e"}, Value: "\u0070\u0072\u0065\u0073\u0065\u0072\u0076\u0065"})
	}
}

var _bec = func() map[string]string {
	_acc := map[string]string{}
	for _ed, _ad := range _bge {
		_acc[_ad] = _ed
	}
	return _acc
}()
...
func Float32(v float32) *float32 { _fdf := v; return &_fdf }
...
func (_efd *nsSet) getPrefix(_aae string) string {
	if _gg, _aca := _bec[_aae]; _aca {
		if _, _accg := _efd._ae[_gg]; !_accg {
			_efd._ae[_gg] = _aae
			_efd._ab[_aae] = _gg
			_efd._bee = append(_efd._bee, _gg)
		}
		return _gg
	}
	_aae = _g.TrimFunc(_aae, func(_daa rune) bool { return !_bb.IsLetter(_daa) })
	if _cbf, _bbc := _efd._ab[_aae]; _bbc {
		return _cbf
	}
	_acd := _g.Split(_aae, "\u002f")
	_acd = _g.Split(_acd[len(_acd)-1], "\u003a")
	_fde := _acd[len(_acd)-1]
	_eb := 0
	_fgf := []byte{}
	for {
		if _eb < len(_fde) {
			_fgf = append(_fgf, _fde[_eb])
		} else {
			_fgf = append(_fgf, '_')
		}
		_eb++
		if _, _aga := _efd._ae[string(_fgf)]; !_aga {
			_efd._ae[string(_fgf)] = _aae
			_efd._ab[_aae] = string(_fgf)
			_efd._bee = append(_efd._bee, string(_fgf))
			return string(_fgf)
		}
	}
}
...
type nsSet struct {
	_ab  map[string]string
	_ae  map[string]string
	_bee []string
}
type any struct {
	XMLName _f.Name
	Attrs   []_f.Attr `xml:",any,attr"`
	Nodes   []*any    `xml:",any"`
	Data    []byte    `xml:",chardata"`
}

var _db = map[string]interface{}{}
...
func Int64(v int64) *int64 { _bd := v; return &_bd }

// Bool returns a copy of v as a pointer.
func Bool(v bool) *bool { _fg := v; return &_fg }

// Uint16 returns a copy of v as a pointer.
func Uint16(v uint16) *uint16 { _cb := v; return &_cb }

// RegisterConstructor registers a constructor function used for unmarshaling
// xsd:any elements.
func RegisterConstructor(ns, name string, fn interface{}) { _db[ns+"\u002f"+name] = fn }

var _gfd = map[string]bool{"\u0077\u0031\u0030": true, "\u0077\u0031\u0034": true, "\u0077\u0070\u0031\u0034": true, "\u0077\u0031\u0035": true, "\u0078\u0031\u0035a\u0063": true, "\u0077\u0031\u0036s\u0065": true, "\u0077\u0031\u0036\u0063\u0069\u0064": true, "\u0077\u0031\u0036": true, "\u0077\u0031\u0036\u0063\u0065\u0078": true}
...
func RelativeFilename(dt DocType, relToTyp, typ string, index int) string {
	_ce := AbsoluteFilename(dt, typ, index)
	if relToTyp == "" {
		return _ce
	}
	_gab := AbsoluteFilename(dt, relToTyp, index)
	_gabc := _g.Split(_gab, "\u002f")
	_ead := _g.Split(_ce, "\u002f")
	_dg := 0
	for _be := 0; _be < len(_gabc); _be++ {
		if _gabc[_be] == _ead[_be] {
			_dg++
		}
		if _be+1 == len(_ead) {
			break
...
func AbsoluteImageFilename(dt DocType, index int, fileExtension string) string {
	_dd := AbsoluteFilename(dt, ImageType, index)
	return _dd[0:len(_dd)-3] + fileExtension
}

// Stringf formats according to a format specifier and returns a pointer to the
// resulting string.
func Stringf(f string, args ...interface{}) *string { _cee := _e.Sprintf(f, args...); return &_cee }

var Log = _fd.Printf

// Any is the interface used for marshaling/unmarshaling xsd:any
type Any interface {
	MarshalXML(_bc *_f.Encoder, _bg _f.StartElement) error
	UnmarshalXML(_d *_f.Decoder, _ge _f.StartElement) error
}
...
func Int32(v int32) *int32 { _geg := v; return &_geg }

// MarshalXML implements the xml.Marshaler interface.
func (_bcd *any) MarshalXML(e *_f.Encoder, start _f.StartElement) error {
	start.Name = _bcd.XMLName
	start.Attr = _bcd.Attrs
	if _bbd := e.EncodeToken(start); _bbd != nil {
		return _bbd
	}
	if len(_bcd.Nodes) > 0 {
		for _, _ag := range _bcd.Nodes {
			if _ff := e.Encode(_ag); _ff != nil {
				return _ff
			}
		}
	}
	if len(_bcd.Data) > 0 {
		if _dcb := e.EncodeToken(_f.CharData(_bcd.Data)); _dcb != nil {
			return _dcb
		}
	}
...
func Uint64(v uint64) *uint64 { _bcc := v; return &_bcc }
